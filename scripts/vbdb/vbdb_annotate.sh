...
do
    echo $f
    java -jar ../PCLocator.jar $@ $f > "annotations_marlin/$(basename $f .c).txt" 2>&1
...
do
    echo $f
    java -jar ../PCLocator.jar $@ $f > "annotations_busybox/$(basename $f .c).txt" 2>&1
...
do
    echo $f
    java -jar ../PCLocator.jar $@ $f > "annotations_linux/$(basename $f .c).txt" 2>&1
