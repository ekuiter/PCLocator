// generated by echo - | gcc -dM - -E -std=gnu99 (clang on macOS)
...
#define _Pragma(...)
#define offsetof(...) 0 // from stddef.h

// see https://github.com/ckaestne/TypeChef-BusyboxAnalysis/blob/master/busybox/config.h
